...
import styles from './MobileVocentraUserCard.module.css';

const MobileVocentraUserCard = ({ onClose }) => {
  const roles = [
    {
      id: 1,
      name: 'Active',
  ...
  return (
    <div className={styles.mobileContainer}>
      ...
      <div className={styles.header}>
        <h3 className={styles.title}>VoCentral Members</h3>
                      ...
                      <div className={styles.activityContainer}>
                        ...
                        {user.activity.lyrics && (
                          <div className={styles.lyrics}>
                            <MdMusicNote className={styles.lyricsIcon}/>
                            <span className={styles.lyricsText}>"{user.activity.lyrics}"</span>
                          </div>
                        )}
                      </div>
                    ) : (
...
export default MobileVocentraUserCard;